...
public class Sedan extends VehiculoHibrido {
    ...
    public String toString() {
        return "Sedan [" + super.toString() + "velocidadCrucero=" + velocidadCrucero + ", sensoresColicion=" + sensoresColicion + ", sensoresTraficoCruzado=" + sensoresTraficoCruzado + ", asistenteConduccion=" + asistenteConduccion  + "]";
    }
